...
##
## Debug
ProjectName            :=systick_6-3
ConfigurationName      :=Debug
WorkspacePath          :=/home/mac/Documents/mop/mopWorkspace
ProjectPath            :=/home/mac/Documents/mop/mopWorkspace/systick_6-3
...
ObjectsFileList        :="systick_6-3.txt"
PCHCompileFlags        :=
...
PostBuild:
	...
	/usr/share/codelite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/systick_6-3.elf Debug/systick_6-3.s19
	/usr/share/codelite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/systick_6-3.elf > Debug/systick_6-3.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "/home/mac/Documents/mop/mopWorkspace/systick_6-3/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
