...
ProjectPath            :=/home/mac/Documents/mop/mopWorkspace/flipflop_irq
...
PostBuild:
	...
	/usr/share/codelite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/flipflop_irq_ack.elf Debug/flipflop_irq_ack.s19
	/usr/share/codelite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/flipflop_irq_ack.elf > Debug/flipflop_irq_ack.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "/home/mac/Documents/mop/mopWorkspace/flipflop_irq/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
