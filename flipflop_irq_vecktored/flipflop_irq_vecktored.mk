...
ProjectPath            :=/home/mac/Documents/mop/mopWorkspace/mop_lab_4/flipflop_irq_vectored/flipflop_irq_vecktored
...
PostBuild:
	...
	/usr/share/codelite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  ./Debug/flipflop_irq_vecktored.elf ./Debug/flipflop_irq_vecktored.s19
	/usr/share/codelite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S ./Debug/flipflop_irq_vecktored.elf > ./Debug/flipflop_irq_vecktored.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "/home/mac/Documents/mop/mopWorkspace/mop_lab_4/flipflop_irq_vectored/flipflop_irq_vecktored/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
